 ...
 * @author Vaadin Ltd
 */
public class DraggingField extends VerticalLayout implements View {
    final List<Component> components = new ArrayList<Component>();
    SortableLayout sample;

    public DraggingField() {
        setMargin(true);
        setSpacing(true);
...
//        opt.setChecked(true);
    ...
    public void addDropComponent(Component component){
...
//        components.add(new TaskView(new Task("", user)));
//        return components;
//    }
